...
DICEAUTH_ORG_ID=$(eval "echo \$${ENV}_DICEAUTH_ORG_ID")
DICEAUTH_USER_ID=$(eval "echo \$${ENV}_DICEAUTH_USER_ID")
DICEAUTH_TC_API_KEY=$(eval "echo \$${ENV}_DICEAUTH_TC_API_KEY")
DICEAUTH_SCHEMA_NAME=$(eval "echo \$${ENV}_DICEAUTH_SCHEMA_NAME")
DICEAUTH_SCHEMA_VERSION=$(eval "echo \$${ENV}_DICEAUTH_SCHEMA_VERSION")
...
APP_RESEND_TOKEN_SECRET=$(eval "echo \$${ENV}_APP_RESEND_TOKEN_SECRET")
...
perl -pi -e "s|\{\{DICEAUTH_ORG_ID\}\}|$DICEAUTH_ORG_ID|g" $CONFFILENAME 
perl -pi -e "s|\{\{DICEAUTH_USER_ID\}\}|$DICEAUTH_USER_ID|g" $CONFFILENAME 
perl -pi -e "s|\{\{DICEAUTH_TC_API_KEY\}\}|$DICEAUTH_TC_API_KEY|g" $CONFFILENAME 
perl -pi -e "s/\{\{DICEAUTH_SCHEMA_NAME\}\}/$DICEAUTH_SCHEMA_NAME/g" $CONFFILENAME 
perl -pi -e "s/\{\{DICEAUTH_SCHEMA_VERSION\}\}/$DICEAUTH_SCHEMA_VERSION/g" $CONFFILENAME 
...
perl -pi -e "s|\{\{APP_RESEND_TOKEN_SECRET\}\}|$APP_RESEND_TOKEN_SECRET|g" $CONFFILENAME 